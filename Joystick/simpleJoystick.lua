...
function Joystick.new( innerRadius, outerRadius )
    ...
    local bgJoystick = display.newImageRect( joyGroup, "gamepad.png", outerRadius*2,outerRadius*2 )
    bgJoystick:setFillColor( .2,.2,.2 )
    
    local radToDeg = 180/math.pi
    local degToRad = math.pi/180
    local joystick = display.newImageRect( joyGroup, "RedBall.png", innerRadius*2, innerRadius*2 )
    --joystick:setFillColor( .8,0,0 )
